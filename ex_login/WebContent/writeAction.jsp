...
<%
	...
	int result = employeeDAO.join(employee_num, employee_rank, employee_name, employee_ssn, employee_day,
			department,employee_phone,homenumber,address,gender,hobby,specialty);
	if(result == 1){
